...
public class VxBatchResultHandler extends ResultHandlerBase {
  private VxStatement vxStatement;
  ...
  private VxResultSet generatedKeys;
  ...
  private VxResultSet latestGeneratedKeysRs;

  VxBatchResultHandler(VxStatement vxStatement, Query[] queries, ParameterList[] parameterLists,
      boolean expectGeneratedKeys) {
    this.vxStatement = vxStatement;
    ...
    if (generatedKeys == null) {
      try {
        ...
        latestGeneratedKeysRs =
            (VxResultSet) vxStatement.createResultSet(fromQuery, fields,
  ...
  private boolean isAutoCommit() {
    try {
      return vxStatement.getConnection().getAutoCommit();
    } catch (SQLException e) {
  ...
  public void handleWarning(SQLWarning warning) {
    vxStatement.addWarning(warning);
  }
  ...
  public VxResultSet getGeneratedKeys() {
