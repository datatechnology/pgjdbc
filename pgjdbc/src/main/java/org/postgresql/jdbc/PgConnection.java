...
public class PgConnection implements BaseConnection {
	...
	// Ctor.
	//
	public PgConnection(QueryExecutor queryExecutor, Properties info, String url) throws SQLException {
	...
	public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
		...
		PgPreparedStatement ps = new PgPreparedStatement(this, cachedQuery, ResultSet.TYPE_FORWARD_ONLY,
