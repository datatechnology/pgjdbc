...
public class PgParameterMetaData implements ParameterMetaData {
	...
	/**
	 * {@inheritDoc} For now report all parameters as inputs. CallableStatements may
	...
	private void checkParamIndex(int param) throws PSQLException {
		if (param < 1 || param > _oids.length) {
			throw new PSQLException(
					GT.tr("The parameter index is out of range: {0}, number of parameters: {1}.", param, _oids.length),
