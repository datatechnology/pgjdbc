...
public interface TypeInfo {
   ...
   */
  Integer getSQLType(int oid) throws SQLException;
   ...
   * @throws SQLException if an error occurs when retrieving sql type
   */
  Integer getSQLType(String pgTypeName) throws SQLException;
   ...
   */
  Integer getPGType(String pgTypeName) throws SQLException;
   ...
   */
  Integer getPGArrayElement(int oid) throws SQLException;
   ...
   */
  Integer getPGArrayType(String elementTypeName) throws SQLException;
   ...
   */
  Character getArrayDelimiter(int oid) throws SQLException;
