...
public interface VxBaseStatement extends PGStatement, Wrapper, AutoCloseable{
   ...
   */
  CompletableFuture<VxResultSet> executeQuery(String sql) throws SQLException;
   ...
   * the currently running {@code Statement}
   */
  CompletableFuture<Integer> executeUpdate(String sql) throws SQLException;
   ...
   * @see #getMoreResults
   */
  CompletableFuture<Boolean> execute(String sql) throws SQLException;
   ...
   * @see #execute
   */
  VxResultSet getResultSet() throws SQLException;
   ...
   * @since 1.2
   */
  CompletableFuture<int[]> executeBatch() throws SQLException;
   ...
   * @since 1.2
   */
  VxConnection getConnection()  throws SQLException;
...
//--------------------------JDBC 3.0-----------------------------
   ...
   * @since 1.4
   */
  VxResultSet getGeneratedKeys() throws SQLException;
   ...
   * @since 1.4
   */
  CompletableFuture<Integer> executeUpdate(String sql, int autoGeneratedKeys) throws SQLException;
   ...
   * @since 1.4
   */
  CompletableFuture<Integer> executeUpdate(String sql, int columnIndexes[]) throws SQLException;
   ...
   * @since 1.4
   */
  CompletableFuture<Integer> executeUpdate(String sql, String columnNames[]) throws SQLException;
   ...
   * @since 1.4
   */
  CompletableFuture<Boolean> execute(String sql, int autoGeneratedKeys) throws SQLException;
   ...
   * @since 1.4
   */
  CompletableFuture<Boolean> execute(String sql, int columnIndexes[]) throws SQLException;
   ...
   * @since 1.4
   */
  CompletableFuture<Boolean> execute(String sql, String columnNames[]) throws SQLException;
