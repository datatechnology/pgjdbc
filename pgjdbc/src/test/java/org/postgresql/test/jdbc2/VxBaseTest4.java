...
public class VxBaseTest4 {
  ...
  public void setUp() throws Exception {
    ...
    con = VxTestUtil.openDB(props).get();
    VxConnection pg = con.unwrap(VxConnection.class);
  ...
  public void assumeMinimumServerVersion(String message, Version version) throws SQLException {
    Assume.assumeTrue(message, VxTestUtil.haveMinimumServerVersion(con, version));
  }
  ...
  public void assumeMinimumServerVersion(Version version) throws SQLException {
    Assume.assumeTrue(VxTestUtil.haveMinimumServerVersion(con, version));
  }
