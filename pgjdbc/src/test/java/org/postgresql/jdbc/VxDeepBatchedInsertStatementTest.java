 ...
 * on.
 */
public class VxDeepBatchedInsertStatementTest extends VxBaseTest4 {
  ...
  public void setUp() throws Exception {
    ...
    VxTestUtil.createTable(con, "testunspecified", "pk INTEGER, bday TIMESTAMP");
...
//    con.setAutoCommit(false);
  ...
  public void tearDown() throws SQLException {
    ...
    try {
      VxTestUtil.dropTable(con, "testunspecified");
    } catch (InterruptedException | ExecutionException e) {
      // TODO Auto-generated catch block
    }
    super.tearDown();
  ...
  public void testDeepInternalsBatchedQueryDecorator() throws Exception {
    ...
    try {
      pstmt = (VxPreparedStatement) con.prepareStatement("INSERT INTO testbatch VALUES (?,?)");
   ...
   */
  @Test
  public void testVaryingTypeCounts() throws SQLException, InterruptedException, ExecutionException {
    VxPreparedStatement pstmt = null;
    try {
      pstmt = (VxPreparedStatement)con.prepareStatement("INSERT INTO testunspecified VALUES (?,?)");
      pstmt.setInt(1, 1);
      pstmt.setDate(2, new Date(1));
      pstmt.addBatch();
   ...
   */
  private BatchedQuery[] transformBQD(VxPreparedStatement ps) throws Exception {
